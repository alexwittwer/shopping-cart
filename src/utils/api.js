...
const ACCESS =
  `https://api.rawg.io/api/games?dates=${lastYear},2023-12-31&ordering=-added`;
const ACCESS2 =
  "https://api.rawg.io/api/games?dates=2023-11-01,2024-01-30&platforms=18,1,7";
const ACCESS3 =
  `https://api.rawg.io/api/games?dates=${today},2024-12-30&ordering=-added`;
...
export { popular, recent, upcoming};
